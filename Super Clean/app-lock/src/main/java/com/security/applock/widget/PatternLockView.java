...
public class PatternLockView extends ViewGroup {
    ...
    private long mFinishTimeout = 1500;
    ...
    public void hidePattern() {
        mNodeHighlightSrc = null;
        mNodeCorrectSrc = null;
        mNodeErrorSrc = null;
        mLineColor  = getContext().getResources().getColor(R.color.color_transparent);
        mLineCorrectColor  = getContext().getResources().getColor(R.color.color_transparent);
        mLineErrorColor  = getContext().getResources().getColor(R.color.color_transparent);
    }
